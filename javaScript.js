...
$(window).on("load", forsideSkaerm);


function forsideSkaerm() {
    console.log("forside");
...
function martinBillede() {
    ...
    setTimeout(kameraKlik, 1300);

}

function kameraKlik() {
    console.log("kameraKlik");
    $("#kamera_lyd")[0].play();
}
...
function flagDecider() {
    console.log("decider");
    $("#martin_sprite").off("animationend");
    if (idiot == 1) {
        negativt();
